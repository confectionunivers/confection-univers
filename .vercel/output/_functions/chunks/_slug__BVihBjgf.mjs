...
import { C as createComponent, S as createAstro, _ as addAttribute, a as renderComponent, b as unescapeHTML, d as renderTemplate, h as maybeRenderHead } from "./server_eIjUU75i.mjs";
...
//#endregion
//#region src/components/BlogSidebar.astro
var $$BlogSidebar = createComponent(($$result, $$props, $$slots) => {
	const recentPosts = BLOG_POSTS.slice(0, 3);
	return renderTemplate`${maybeRenderHead($$result)}<aside class="space-y-6" data-astro-cid-fw45jw3s><!-- Search Widget --><div class="widget-card p-6 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.6)] hover:border-orange-500/30" style="background: #00002a; border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 24px;" data-astro-cid-fw45jw3s><h3 class="mb-4 text-lg font-extrabold tracking-tight text-white" data-astro-cid-fw45jw3s>Rechercher</h3><div class="relative" data-astro-cid-fw45jw3s><input type="text" placeholder="Rechercher un article..." class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 transition-all duration-300 focus:border-[#F5B544] focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#F5B544]/20" data-astro-cid-fw45jw3s><svg class="absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 text-white/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-fw45jw3s><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-astro-cid-fw45jw3s></path></svg></div></div><!-- Recent Posts Widget --><div class="widget-card p-6 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.6)] hover:border-orange-500/30" style="background: #00002a; border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 24px;" data-astro-cid-fw45jw3s><h3 class="mb-4 text-lg font-extrabold tracking-tight text-white" data-astro-cid-fw45jw3s>Articles Récents</h3><div class="space-y-4" data-astro-cid-fw45jw3s>${recentPosts.map((post) => renderTemplate`<a${addAttribute(`/blog/${post.slug}`, "href")} class="group flex gap-4 transition-all duration-300 hover:translate-x-1" data-astro-cid-fw45jw3s><div class="relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-xl" data-astro-cid-fw45jw3s><img${addAttribute(post.image, "src")}${addAttribute(post.title, "alt")} class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110" data-astro-cid-fw45jw3s></div><div class="flex flex-col justify-center" data-astro-cid-fw45jw3s><h4 class="mb-1 text-sm font-bold leading-tight text-white group-hover:text-[#F5B544] transition-colors line-clamp-2" data-astro-cid-fw45jw3s>${post.title}</h4><div class="text-xs font-semibold tracking-widest uppercase" style="color: #9CA3AF;" data-astro-cid-fw45jw3s>${post.date}</div></div></a>`)}</div></div><!-- Categories Widget --><div class="widget-card p-6 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.6)] hover:border-orange-500/30" style="background: #00002a; border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 24px;" data-astro-cid-fw45jw3s><h3 class="mb-4 text-lg font-extrabold tracking-tight text-white" data-astro-cid-fw45jw3s>Catégories</h3><ul class="space-y-3" data-astro-cid-fw45jw3s><li data-astro-cid-fw45jw3s><a href="#" class="group flex items-center justify-between rounded-lg px-4 py-3 transition-all duration-300 hover:bg-white/5 hover:-translate-x-1" data-astro-cid-fw45jw3s><span class="text-white/80 group-hover:text-white" data-astro-cid-fw45jw3s>Uniformes Scolaires</span><span class="text-sm font-semibold" style="color: #F5B544;" data-astro-cid-fw45jw3s>12</span></a></li><li data-astro-cid-fw45jw3s><a href="#" class="group flex items-center justify-between rounded-lg px-4 py-3 transition-all duration-300 hover:bg-white/5 hover:-translate-x-1" data-astro-cid-fw45jw3s><span class="text-white/80 group-hover:text-white" data-astro-cid-fw45jw3s>Tenues de Travail</span><span class="text-sm font-semibold" style="color: #F5B544;" data-astro-cid-fw45jw3s>8</span></a></li><li data-astro-cid-fw45jw3s><a href="#" class="group flex items-center justify-between rounded-lg px-4 py-3 transition-all duration-300 hover:bg-white/5 hover:-translate-x-1" data-astro-cid-fw45jw3s><span class="text-white/80 group-hover:text-white" data-astro-cid-fw45jw3s>Médical & Santé</span><span class="text-sm font-semibold" style="color: #F5B544;" data-astro-cid-fw45jw3s>5</span></a></li><li data-astro-cid-fw45jw3s><a href="#" class="group flex items-center justify-between rounded-lg px-4 py-3 transition-all duration-300 hover:bg-white/5 hover:-translate-x-1" data-astro-cid-fw45jw3s><span class="text-white/80 group-hover:text-white" data-astro-cid-fw45jw3s>Événements & Cérémonies</span><span class="text-sm font-semibold" style="color: #F5B544;" data-astro-cid-fw45jw3s>7</span></a></li><li data-astro-cid-fw45jw3s><a href="#" class="group flex items-center justify-between rounded-lg px-4 py-3 transition-all duration-300 hover:bg-white/5 hover:-translate-x-1" data-astro-cid-fw45jw3s><span class="text-white/80 group-hover:text-white" data-astro-cid-fw45jw3s>Conseils & Tendances</span><span class="text-sm font-semibold" style="color: #F5B544;" data-astro-cid-fw45jw3s>15</span></a></li></ul></div><!-- CTA Widget --><div class="widget-card p-6 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.6)] hover:border-orange-500/30" style="background: linear-gradient(135deg, #00002a 0%, #0E172A 100%); border: 2px solid rgba(245, 181, 68, 0.3); border-radius: 24px;" data-astro-cid-fw45jw3s><div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl" style="background: rgba(245, 181, 68, 0.1);" data-astro-cid-fw45jw3s><svg class="h-6 w-6" style="color: #F5B544;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-fw45jw3s><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-astro-cid-fw45jw3s></path></svg></div><h3 class="mb-3 text-xl font-extrabold tracking-tight text-white" data-astro-cid-fw45jw3s>Un projet de confection pour votre institution ?</h3><p class="mb-6 text-sm leading-relaxed" style="color: #9CA3AF;" data-astro-cid-fw45jw3s>Obtenez un devis personnalisé pour vos tenues professionnelles en quelques clics.</p><a href="/contact" class="btn-hero-primary w-full justify-center" data-astro-cid-fw45jw3s><span data-astro-cid-fw45jw3s>Demander un devis</span><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-fw45jw3s><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" data-astro-cid-fw45jw3s></path></svg></a></div></aside>`;
}, "C:/GitHub/confection univers/src/components/BlogSidebar.astro", void 0);
//#endregion
//#region src/components/CommentForm.astro
var $$CommentForm = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${maybeRenderHead($$result)}<section class="rounded-2xl p-6 shadow-2xl" style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1);"><h3 class="mb-6 font-display text-xl font-bold uppercase tracking-tight text-white">Laisser un commentaire</h3><form class="space-y-6"><div class="grid gap-6 md:grid-cols-2"><div><label for="name" class="mb-2 block text-sm font-semibold uppercase tracking-wider" style="color: #A0ACC6;">Nom</label><input type="text" id="name" name="name" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 transition-all duration-300 focus:border-[#F5B544] focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#F5B544]/20" placeholder="Votre nom"></div><div><label for="email" class="mb-2 block text-sm font-semibold uppercase tracking-wider" style="color: #A0ACC6;">Email</label><input type="email" id="email" name="email" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 transition-all duration-300 focus:border-[#F5B544] focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#F5B544]/20" placeholder="votre@email.com"></div></div><div><label for="comment" class="mb-2 block text-sm font-semibold uppercase tracking-wider" style="color: #A0ACC6;">Commentaire</label><textarea id="comment" name="comment" rows="5" required class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 transition-all duration-300 focus:border-[#F5B544] focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#F5B544]/20 resize-none" placeholder="Partagez vos thoughts..."></textarea></div><button type="submit" class="btn-hero-primary w-full justify-center"><span>Envoyer le commentaire</span></button></form></section>`;
...
var $$Slug = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		"title": `${post.title} - Confection Univers`,
		"data-astro-cid-zg7dkzxc": true
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<main class="relative" data-astro-cid-zg7dkzxc>${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-zg7dkzxc": true })}<!-- Article Hero --><section class="relative overflow-hidden py-16 md:py-24" style="background: linear-gradient(135deg, #00001C 0%, #00002a 100%);" data-astro-cid-zg7dkzxc><!-- Background Glow --><div class="pointer-events-none absolute inset-0 -z-10 overflow-hidden" data-astro-cid-zg7dkzxc><div class="absolute left-[10%] top-[20%] w-[500px] h-[500px] rounded-full" style="background: radial-gradient(ellipse, rgba(245, 181, 68, 0.08) 0%, transparent 70%); filter: blur(120px);" data-astro-cid-zg7dkzxc></div></div><div class="mx-auto max-w-7xl px-6 md:px-10" data-astro-cid-zg7dkzxc><!-- Category --><div class="mb-4 inline-block rounded-full px-4 py-2 text-xs font-bold uppercase tracking-wider" style="background: rgba(245, 181, 68, 0.9); color: #00001C;" data-astro-cid-zg7dkzxc>${post.category}</div><!-- Title --><h1 class="hero-title font-display text-3xl font-bold uppercase tracking-tight text-white md:text-4xl lg:text-5xl" data-astro-cid-zg7dkzxc>${post.title}</h1><!-- Meta --><div class="mt-6 flex flex-wrap items-center gap-6 text-sm font-semibold uppercase tracking-wider" style="color: #A0ACC6;" data-astro-cid-zg7dkzxc><div class="flex items-center gap-2" data-astro-cid-zg7dkzxc><svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-zg7dkzxc><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-astro-cid-zg7dkzxc></path></svg><span data-astro-cid-zg7dkzxc>${post.date}</span></div><div class="flex items-center gap-2" data-astro-cid-zg7dkzxc><svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-zg7dkzxc><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-zg7dkzxc></path></svg><span data-astro-cid-zg7dkzxc>${post.author}</span></div></div></div></section><!-- Main Content --><section class="py-16 md:py-24" style="background: #00001C;" data-astro-cid-zg7dkzxc><div class="mx-auto max-w-7xl px-6 md:px-10" data-astro-cid-zg7dkzxc><div class="grid gap-10 lg:grid-cols-12" data-astro-cid-zg7dkzxc><!-- Main Content (70%) --><div class="lg:col-span-8" data-astro-cid-zg7dkzxc><!-- Featured Image --><div class="mb-8 overflow-hidden rounded-2xl shadow-2xl" style="border: 1px solid rgba(255, 255, 255, 0.1);" data-astro-cid-zg7dkzxc><img${addAttribute(post.image, "src")}${addAttribute(post.title, "alt")} class="h-full w-full object-cover" data-astro-cid-zg7dkzxc></div><!-- Article Content --><article class="prose prose-invert max-w-none" data-astro-cid-zg7dkzxc><div class="rounded-2xl p-8 md:p-12" style="background: #00002a; border: 1px solid rgba(255, 255, 255, 0.1);" data-astro-cid-zg7dkzxc><div class="article-content" data-astro-cid-zg7dkzxc>${unescapeHTML(post.content)}</div></div></article><!-- CTA Block --><div class="mt-12 rounded-2xl p-8 shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[#F5B544]/20" style="background: linear-gradient(135deg, #00002a 0%, #0E172A 100%); border: 2px solid rgba(245, 181, 68, 0.3);" data-astro-cid-zg7dkzxc><div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl" style="background: rgba(245, 181, 68, 0.1);" data-astro-cid-zg7dkzxc><svg class="h-6 w-6" style="color: #F5B544;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-zg7dkzxc><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-astro-cid-zg7dkzxc></path></svg></div><h3 class="mb-3 font-display text-xl font-bold uppercase tracking-tight text-white" data-astro-cid-zg7dkzxc>Un projet de confection pour votre institution ?</h3><p class="mb-6 text-sm leading-relaxed" style="color: #A0ACC6;" data-astro-cid-zg7dkzxc>Cet article vous a intéressé ? Contactez Confection Univers pour discuter de votre projet de tenues professionnelles.</p><a href="/contact" class="btn-hero-primary inline-flex justify-center" data-astro-cid-zg7dkzxc><span data-astro-cid-zg7dkzxc>Demander un devis</span><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-astro-cid-zg7dkzxc><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" data-astro-cid-zg7dkzxc></path></svg></a></div><!-- Comment Form --><div class="mt-12" data-astro-cid-zg7dkzxc>${renderComponent($$result, "CommentForm", $$CommentForm, { "data-astro-cid-zg7dkzxc": true })}</div></div><!-- Sidebar (30%) --><div class="lg:col-span-4" data-astro-cid-zg7dkzxc>${renderComponent($$result, "BlogSidebar", $$BlogSidebar, { "data-astro-cid-zg7dkzxc": true })}</div></div></div></section>${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-zg7dkzxc": true })}</main>` })}`;
}, "C:/GitHub/confection univers/src/pages/blog/[slug].astro", void 0);
var $$file = "C:/GitHub/confection univers/src/pages/blog/[slug].astro";
var $$url = "/blog/[slug]";
//#endregion
